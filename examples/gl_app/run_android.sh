...
# ============================================================
# run_android.sh — сборка + установка + логи для gl_app
#
...
# 6. Показывает логи с фильтром egui-gl-app
#
# Использование:
#   cd examples/gl_app && ./run_android.sh
#   cd examples/gl_app && ./run_android.sh --release
#   cd examples/gl_app && ./run_android.sh --run
# ============================================================
...
LOG_TAG="egui-gl-app"                      # фильтр для adb logcat
...
# чтобы подставить правильный манифест (examples/gl_app/AndroidManifest.xml)
export APP_LIB_NAME="${CRATE//-/_}"       # egui_gl_app
