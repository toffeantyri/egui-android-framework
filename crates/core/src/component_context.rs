...
//!
//! Единая точка кастомной логики — [`ComponentNode::handle_back()`],
//! возвращающая [`BackAction`]. Рисованная кнопка «← Назад» делегирует в неё
//! из `Component::handle()`, платформенная — через `ChildStack::on_back()`.
//!
