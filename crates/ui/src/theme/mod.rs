...
impl Theme {
    pub fn apply(&self, ctx: &egui::Context) {
        ...
        style.visuals.widgets.inactive.fg_stroke = egui::Stroke::new(1.0, self.colors.on_surface);
        ...
        style.visuals.widgets.hovered.fg_stroke = egui::Stroke::new(1.0, self.colors.on_primary);
